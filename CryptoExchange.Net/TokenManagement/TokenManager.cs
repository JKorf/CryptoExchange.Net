...
namespace CryptoExchange.Net.TokenManagement
{
    ...
    public class TokenManager
    {
        ...
        public Task<CallResult<TokenLease>> AcquireAsync(TokenScope scope, CancellationToken ct = default)
            => _registry.AcquireAsync(_logger, scope, _refreshInterval, _timeValid, _operations, ct);
        ...
        {
            var acquireResult = await _registry.AcquireAsync(_logger, scope, _refreshInterval, _timeValid, _operations, ct).ConfigureAwait(false);
