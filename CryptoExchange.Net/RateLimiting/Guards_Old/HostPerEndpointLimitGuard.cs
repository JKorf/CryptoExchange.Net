...
//{
//    /// <summary>
//    /// Host per endpoint limit guard, limit the amount of call to a certain host
//    /// </summary>
//    public class HostPerEndpointLimitGuard : LimitGuard, IRateLimitGuard
//    {
//        /// <inheritdoc />
...
//        public HostPerEndpointLimitGuard(string host, int limit, TimeSpan timespan, RateLimitItemType types = RateLimitItemType.Request) : base(limit, timespan)
//        {
//            _host = host;
//            _types = types;
