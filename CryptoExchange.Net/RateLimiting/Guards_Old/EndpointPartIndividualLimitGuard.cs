...
//    /// </summary>
//    public class EndpointPartIndividualLimitGuard : LimitGuard, IRateLimitGuard
//    {
//        /// <inheritdoc />
...
//        public EndpointPartIndividualLimitGuard(string endpoint, int limit, TimeSpan timespan, RateLimitItemType types = RateLimitItemType.Request) : base(limit, timespan)
//        {
//            _endpoint = endpoint;
