...
public abstract class Subscription : IMessageProcessor
{
    ...
    /// </summary>
    public Task<CallResult> Handle(SocketConnection connection, DataEvent<object> message, MessageHandlerLink matchedHandler)
    {
        ConnectionInvocations++;
        TotalInvocations++;
        return Task.FromResult(matchedHandler.Handle(connection, message));
    }
