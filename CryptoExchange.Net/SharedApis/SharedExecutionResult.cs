...
//        /// </summary>
//        public HttpResult<Unit>? CallResult { get; init; }
//        /// <summary>
//        /// Next page request
//        /// </summary>
...
//        public static SharedExecutionResult<TResult> Ok<TResult>(IHttpResult callResult, TResult data) => new SharedExecutionResult<TResult>(callResult, data, null);
//        /// <summary>
//        /// Create a success result
//        /// </summary>
//        /// <param name="callResult">Call result</param>
...
//        public static SharedExecutionResult<TResult> Ok<TResult>(IHttpResult callResult, TResult data, PageRequest? nextPageRequest) => new SharedExecutionResult<TResult>(callResult, data, nextPageRequest);
//        /// <summary>
//        /// Create an error result
//        /// </summary>
//        /// <param name="callResult">The failed result</param>
//        public static SharedExecutionResult<TResult> Error<TResult>(IHttpResult callResult) => new SharedExecutionResult<TResult>(callResult, default, default);
//        /// <summary>
//        /// Create an error result
//        /// </summary>
...
//        internal SharedExecutionResult(IHttpResult callResult, TResult? data, PageRequest? nextPageRequest)
//        {
