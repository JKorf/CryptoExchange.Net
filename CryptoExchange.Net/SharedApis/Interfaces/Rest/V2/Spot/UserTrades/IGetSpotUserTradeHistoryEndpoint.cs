...
{
    /// <summary>
    /// Request definition for getting spot user trade history from an exchange
    /// </summary>
    public interface IGetSpotUserTradeHistoryEndpoint : ISharedApiEndpoint
    {
        /// <summary>
        ...
        Task<HttpResult<SharedUserTrade[]>> GetSpotUserTradeHistoryAsync(GetUserTradesRequest request, PageRequest? nextPageToken = null, CancellationToken ct = default);
    }
}
