...
namespace CryptoExchange.Net.SharedApis
{
    ...
    public interface ITickersSocketClient : ISharedClient
    {
        ...
        /// <returns></returns>
        Task<WebSocketResult<UpdateSubscription>> SubscribeToAllTickersUpdatesAsync(SubscribeAllTickersRequest request, Action<DataEvent<SharedSpotTicker[]>> handler, CancellationToken ct = default);
    }
}
