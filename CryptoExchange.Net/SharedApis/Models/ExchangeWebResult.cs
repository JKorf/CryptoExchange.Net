...
public class ExchangeWebResult<T> : WebCallResult<T>
{
    ...
    /// <returns></returns>
    public new ExchangeWebResult<TNew> As<TNew>([AllowNull] TNew data)
    {
        return new ExchangeWebResult<TNew>(Exchange, DataTradeMode, ResponseStatusCode, ResponseHeaders, ResponseTime, ResponseLength, OriginalData, RequestId, RequestUrl, RequestBody, RequestMethod, RequestHeaders, DataSource, data, Error, NextPageToken);
    }
