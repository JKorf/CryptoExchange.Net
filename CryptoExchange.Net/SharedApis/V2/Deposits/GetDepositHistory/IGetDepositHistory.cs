...
{
    /// <summary>
    /// Operation for retrieving user deposit history from an exchange.
    /// </summary>
    public interface IGetDepositHistory : ISharedApiCapability
    {
        /// <summary>
        ...
        /// <returns></returns>
        Task<IExchangeCallResult<SharedDeposit[]>> GetDepositHistoryAsync(GetDepositsRequest request, PageRequest? nextPageToken = null, CancellationToken ct = default);
    }

    /// <summary>
    /// Operation for retrieving user deposit history from an exchange via the REST API.
    /// </summary>
    public interface IGetDepositHistoryRest : IGetDepositHistory, ISharedRest
    {
        /// <inheritdoc />
        new Task<HttpResult<SharedDeposit[]>> GetDepositHistoryAsync(GetDepositsRequest request, PageRequest? nextPageToken = null, CancellationToken ct = default);
    }
}
