...
{
    /// <summary>
    /// Operation for retrieving funding rate history for a symbol on an exchange.
    /// </summary>
    public interface IGetFundingRateHistory : ISharedApiCapability
    {
        /// <summary>
        ...
        Task<IExchangeCallResult<SharedFundingRate[]>> GetFundingRateHistoryAsync(GetFundingRateHistoryRequest request, PageRequest? nextPageToken = null, CancellationToken ct = default);
    }

    /// <summary>
    /// Operation for retrieving funding rate history for a symbol on an exchange via the REST API.
    /// </summary>
    public interface IGetFundingRateHistoryRest : IGetFundingRateHistory, ISharedRest
    {
        /// <inheritdoc />
        new Task<HttpResult<SharedFundingRate[]>> GetFundingRateHistoryAsync(GetFundingRateHistoryRequest request, PageRequest? nextPageToken = null, CancellationToken ct = default);
    }
}
