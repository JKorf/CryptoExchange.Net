...
{
    /// <summary>
    /// Operation for retrieving position history from an exchange.
    /// </summary>
    public interface IGetPositionHistory : ISharedApiCapability
    {
        /// <summary>
        ...
        Task<IExchangeCallResult<SharedPositionHistory[]>> GetPositionHistoryAsync(GetPositionHistoryRequest request, PageRequest? nextPageToken = null, CancellationToken ct = default);
    }

    /// <summary>
    /// Operation for retrieving position history from an exchange via the REST API.
    /// </summary>
    public interface IGetPositionHistoryRest : IGetPositionHistory, ISharedRest
    {
        /// <inheritdoc />
        new Task<HttpResult<SharedPositionHistory[]>> GetPositionHistoryAsync(GetPositionHistoryRequest request, PageRequest? nextPageToken = null, CancellationToken ct = default);
    }
}
