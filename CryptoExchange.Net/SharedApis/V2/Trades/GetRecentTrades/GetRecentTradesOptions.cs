...
namespace CryptoExchange.Net.SharedApis
{
    ...
    /// </summary>
    public class GetRecentTradesOptions : CapabilityOptions<GetRecentTradesRequest, IGetRecentTrades>
    {
        /// <inheritdoc />
        ...
        public GetRecentTradesOptions(string exchange, int limit, bool authenticated) 
            : base(exchange, authenticated, nameof(IGetRecentTrades.GetRecentTradesAsync), _defaultParameterRules)
        {
            MaxLimit = limit;
        }

        /// <inheritdoc />
        public override Error? ValidateRequest(GetRecentTradesRequest request, IGetRecentTrades client)
        {
