...
namespace CryptoExchange.Net.SharedApis
{
    ...
    public interface IGetWithdrawalHistory : ISharedApiCapability
    {
        ...
        /// <returns></returns>
        Task<IExchangeCallResult<SharedWithdrawal[]>> GetWithdrawalHistoryAsync(GetWithdrawalsRequest request, PageRequest? nextPageToken = null, CancellationToken ct = default);
    }
