...
namespace CryptoExchange.Net.SharedApis
{
    ...
    /// </summary>
    public class EditFuturesOrderOptions : CapabilityOptions<EditOrderRequest, IEditFuturesOrder>
    {
        /// <inheritdoc />
        ...
        private static readonly RequestParameterDescription[] _defaultParameterRules = new[]
        {
            ...
            RequestParameterRule<EditOrderRequest>.Required(x => x.OrderId, "The id of the order to edit", "123"),
