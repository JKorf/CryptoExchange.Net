...
namespace CryptoExchange.Net.SharedApis
{
    ...
    public interface IGetClosedFuturesOrders : ISharedApiCapability
    {
        ...
        Task<IExchangeCallResult<SharedFuturesOrder[]>> GetClosedFuturesOrdersAsync(GetClosedOrdersRequest request, PageRequest? nextPageToken = null, CancellationToken ct = default);
    }
