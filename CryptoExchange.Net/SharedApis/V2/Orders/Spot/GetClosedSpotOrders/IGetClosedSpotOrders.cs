...
{
    /// <summary>
    /// Operation for retrieving closed spot orders from an exchange.
    /// </summary>
    public interface IGetClosedSpotOrders : ISharedApiCapability
    {
        /// <summary>
        ...
        Task<IExchangeCallResult<SharedSpotOrder[]>> GetClosedSpotOrdersAsync(GetClosedOrdersRequest request, PageRequest? nextPageToken = null, CancellationToken ct = default);
    }

    /// <summary>
    /// Operation for retrieving closed spot orders from an exchange via the REST API.
    /// </summary>
    public interface IGetClosedSpotOrdersRest : IGetClosedSpotOrders, ISharedRest
    {
        /// <inheritdoc />
        new Task<HttpResult<SharedSpotOrder[]>> GetClosedSpotOrdersAsync(GetClosedOrdersRequest request, PageRequest? nextPageToken = null, CancellationToken ct = default);
    }
}
