...
namespace CryptoExchange.Net.Trackers.OrderBooks
{
    /// <summary>
    /// Base for order book implementations
    /// </summary>
    public abstract class OrderBookTracker : ISymbolOrderBook, IDisposable
    {
        ...
        public ISymbolOrderBookEntry? BestBid
        {
            ...
            {
                lock (_bookLock)
                    return _bids.FirstOrDefault().Value;
            }
        }
        ...
        public ISymbolOrderBookEntry? BestAsk
        {
            ...
            {
                lock (_bookLock)
                    return _asks.FirstOrDefault().Value;
            }
        }
        ...
        protected OrderBookTracker(ILogger? logger, string id, string symbol)
        {
            if (symbol == null)
