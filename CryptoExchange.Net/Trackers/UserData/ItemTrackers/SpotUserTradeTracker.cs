...
namespace CryptoExchange.Net.Trackers.UserData.ItemTrackers
{
    ...
    {
        private readonly IGetSpotUserTradeHistoryRest _restClient;
        ...
        public SpotUserTradeTracker(
            ...
            IGetSpotUserTradeHistoryRest restClient,
        ...
        protected override Task<WebSocketResult<UpdateSubscription?>> DoSubscribeAsync()
        {
            ...
            return ExchangeHelpers.ProcessQueuedAsync<SharedUserTrade[]>(
                async handler => await _socketClient.SubscribeToUserTradeUpdatesAsync(new SubscribeUserTradeRequest(exchangeParameters: _exchangeParameters), handler, ct: _cts!.Token).ConfigureAwait(false),
