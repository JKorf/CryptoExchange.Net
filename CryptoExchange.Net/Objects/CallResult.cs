...
//        /// </summary>
//        public static CallResult SuccessResult { get; } = CallResult.Fail((Error?)null);
...
//        /// <summary>
//        /// Copy the HttpResult to a new data type with default value
//        /// </summary>
...
//        /// <summary>
//        /// Copy the HttpResult to a new data type
//        /// </summary>
//        /// <typeparam name="K">The new type</typeparam>
...
//    /// </summary>
//    public record HttpResult<T> : CallResult<T>, IHttpResult
//    {
//        /// <summary>
//        /// The request http method
//        /// </summary>
...
//        /// </summary>
//        /// <param name="error"></param>
//        public HttpResult(Error error): base(error) { }
...
//        /// <param name="error">The error returned</param>
//        /// <returns></returns>
//        public HttpResult<T> AsError(Error error)
//        {
...
//        /// <typeparam name="K">The new type</typeparam>
//        /// <returns></returns>
//        public new HttpResult<K> As<K>()
//        {
//            return new HttpResult<K>(
//                ResponseStatusCode, 
//                HttpVersion, 
//                ResponseHeaders, 
//                ResponseTime,
...
//        /// <param name="data">The data of the new type</param>
//        /// <returns></returns>
//        public new HttpResult<K> As<K>([AllowNull] K data)
//        {
//            return new HttpResult<K>(
//                ResponseStatusCode,
//                HttpVersion, 
...
//        /// <param name="error">The error returned</param>
//        /// <returns></returns>
//        public new HttpResult<K> AsError<K>(Error error)
//        {
//            return new HttpResult<K>(
//                ResponseStatusCode,
//                HttpVersion,
...
//        /// <param name="error">The error returned</param>
//        /// <returns></returns>
//        public new HttpResult<K> AsErrorWithData<K>(Error error, K data)
//        {
//            return new HttpResult<K>(
//                ResponseStatusCode,
//                HttpVersion,
...
//        /// </summary>
//        /// <returns></returns>
//        public new HttpResult AsDataless()
//        {
...
//        /// </summary>
//        /// <returns></returns>
//        public new HttpResult AsDatalessError(Error error)
//        {
//            return new HttpResult(
//                ResponseStatusCode,
//                HttpVersion, 
...
//        /// </summary>
//        /// <returns></returns>
//        internal HttpResult<T> Cached()
//        {
//            return new HttpResult<T>(ResponseStatusCode, HttpVersion, ResponseHeaders, ResponseTime, ResponseLength, OriginalData, RequestId, RequestUrl, RequestBody, RequestMethod, RequestHeaders, ResultDataSource.Cache, Data, Error);
//        }

//        ///// <summary>
//        ///// Copy the HttpResult to an ExchangeWebResult of a new data type
//        ///// </summary>
//        ///// <typeparam name="K">The new type</typeparam>
...
//        ///// <param name="data">The data</param>
//        ///// <returns></returns>
//        //public HttpResult<K> AsExchangeWebSocketResult<K>(string exchange, TradingMode tradeMode, [AllowNull] K data)
//        //{
//        //    return new HttpResult<K>(exchange, tradeMode, this.As<K>(data));
//        //}
...
//        ///// <param name="data">The data</param>
//        ///// <returns></returns>
//        //public HttpResult<K> AsExchangeWebSocketResult<K>(string exchange, TradingMode[]? tradeModes, [AllowNull] K data)
//        //{
//        //    return new HttpResult<K>(exchange, tradeModes, this.As<K>(data));
//        //}
...
//        ///// <param name="exchange">The exchange</param>
//        ///// <returns></returns>
//        //public HttpResult<K> AsExchangeWebSocketResult<K>(string exchange)
//        //{
//        //    return new HttpResult<K>(exchange, (TradingMode)default, this.As<K>(default));
//        //}
...
//        ///// <returns></returns>
//        //public HttpResult<K> AsExchangeError<K>(string exchange, Error error)
//        //{
//        //    return new HttpResult<K>(exchange, error);
//        //}
...
//    /// The result of a request
//    /// </summary>
//    public record HttpResult : HttpResult<object>, IHttpResult<object>
//    {
//        /// <summary>
//        /// Create a new result
//        /// </summary>
...
//        /// </summary>
//        /// <param name="error">The error</param>
//        public HttpResult(Error? error) : this(null, null, null, null, null, null, null, null, null, null, null, ResultDataSource.Server, error) { }
...
//        ///// <param name="tradeMode">Trade mode the result applies to</param>
//        ///// <returns></returns>
//        //public HttpResult<T> AsExchangeResult(string exchange, TradingMode tradeMode)
//        //{
//        //    return new HttpResult<T>(exchange, tradeMode, this);
//        //}
...
//        ///// <param name="tradeModes">Trade modes the result applies to</param>
//        ///// <returns></returns>
//        //public HttpResult<T> AsExchangeResult(string exchange, TradingMode[] tradeModes)
//        //{
//        //    return new HttpResult<T>(exchange, tradeModes, this);
//        //}
...
//        ///// <returns></returns>
//        //public HttpResult<K> AsExchangeWebSocketResult<K>(string exchange, TradingMode tradeMode, [AllowNull] K data, PageRequest? nextPageRequest = null)
//        //{
//        //    return new HttpResult<K>(exchange, tradeMode, As<K>(data), nextPageRequest);
//        //}
...
//        ///// <returns></returns>
//        //public HttpResult<K> AsExchangeWebSocketResult<K>(string exchange, TradingMode[]? tradeModes, [AllowNull] K data, PageRequest? nextPageRequest = null)
//        //{
//        //    return new HttpResult<K>(exchange, tradeModes, As<K>(data), nextPageRequest);
//        //}

//        ///// <summary>
//        ///// Copy the HttpResult to an ExchangeWebResult with a specific error
//        ///// </summary>
//        ///// <typeparam name="K">The new type</typeparam>
//        ///// <param name="exchange">The exchange</param>
//        ///// <param name="error">The error returned</param>
...
//        //public HttpResult<K> AsExchangeError<K>(string exchange, Error error)
//        //{
//        //    return new HttpResult<K>(exchange, null, AsError<K>(error));
//        //}
//    }
//}
